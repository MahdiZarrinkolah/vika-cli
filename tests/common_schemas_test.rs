...
fn test_detect_common_schemas() {
    ...
    module_schemas.insert(
        "users".to_string(),
        vec!["User".to_string(), "CommonResponse".to_string()],
    );
    module_schemas.insert(
        "products".to_string(),
        vec!["Product".to_string(), "CommonResponse".to_string()],
    );
    ...
    assert!(!filtered
        .get("users")
        .unwrap()
        .contains(&"CommonResponse".to_string()));
    assert!(!filtered
        .get("products")
        .unwrap()
        .contains(&"CommonResponse".to_string()));
...
fn test_common_schemas_three_modules() {
    ...
    module_schemas.insert(
        "orders".to_string(),
        vec!["Order".to_string(), "Common".to_string()],
    );
